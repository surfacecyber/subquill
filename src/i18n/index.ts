...
const messages = {
  zh: {
    ...
    aboutUpdatesTitle: "更新",
    aboutUpdates:
      "Subquill 仅以源码分发，不提供预编译安装包。从 GitHub 拉取最新代码并重新构建即可更新。",
    aboutSourceRepo: "查看源码仓库",
    version: "版本",
    previewExpand: "展开预览",
  ...
  en: {
    ...
    aboutUpdates:
      "Subquill is distributed as source only — no pre-built installers. Pull the latest code from GitHub and rebuild to update.",
    aboutSourceRepo: "View source repository",
    version: "Version",
