...
Index of project docs. Product overview and quick start live in the [root README](../README.md).
...
Agent-oriented GitNexus guidance remains at the repo root: [AGENTS.md](../AGENTS.md), [CLAUDE.md](../CLAUDE.md) (English only).
